 ...
 */
function getVersionInfo(versionMatch, includePrerelease) {
    ...
    var json = fs.readFileSync(constants_1.VERSIONS_FILE, {
        encoding: 'utf8',
    });
    var content = JSON.parse(json);
    return content.versions.find(function (v) { return v.version === max; });
}
