...
import { CatchQRCallback, CreateOptions, LoadingScreenCallback, StatusFindCallback } from '../api/model/initializer';
 ...
 */
export declare function create(sessionName: string, catchQR?: CatchQRCallback, statusFind?: StatusFindCallback, onLoadingScreen?: LoadingScreenCallback, options?: CreateConfig, browserSessionToken?: SessionToken): Promise<Whatsapp>;
